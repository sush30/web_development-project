...
$tb1.='<tr>
			...
			<th style ="border : 1px solid #000;">inspection_id</th>
			<th  style ="border : 1px solid #000;">property_id</th>
			<th  style ="border : 1px solid #000;">inspector</th>
			<th  style ="border : 1px solid #000;">inspection_date</th>
			
</tr>';

foreach($consumers1 as $record){
		$tb1.='<tr>
			
			<td  style ="border : 1px solid #000;">'.$record->inspection_id.'</td>
			
			<td  style ="border : 1px solid #000;">'.$record->property_id.'</td>
			<td  style ="border : 1px solid #000;">'.$record->inspector.'</td>
			<td  style ="border : 1px solid #000;">'.$record->inspection_date.'</td>
